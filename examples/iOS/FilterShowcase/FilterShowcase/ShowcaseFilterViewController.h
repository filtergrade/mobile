...
typedef enum {
    ...
    GPUIMAGE_SHARP,
    GPUIMAGE_GRADIENT,
    GPUIMAGE_GRADIENT_RADIAL,
    GPUIMAGE_INTERACTIVE_OVERLAY,
    GPUIMAGE_WASTED,
    GPUIMAGE_NOISE_TEXTURE,
    GPUIMAGE_SATURATION,
    GPUIMAGE_CONTRAST,
    GPUIMAGE_BRIGHTNESS,
    GPUIMAGE_LEVELS,
...
@protocol ShowcaseFilterDelegate <NSObject>

- (void) addFilterFromShowcaseFilterViewController:(GPUImageOutput<GPUImageInput> *)filter
...
@property (nonatomic, weak) id<ShowcaseFilterDelegate> delegate;
