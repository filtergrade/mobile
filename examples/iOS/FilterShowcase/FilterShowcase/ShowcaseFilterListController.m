...
@interface ShowcaseFilterListController ()
    <ShowcaseFilterDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    self.originalImage = [UIImage imageNamed:@"flowersLrg.jpg"];    
    
    self.image = [UIImage imageWithImage:self.originalImage
                           scaledToWidth:[[UIScreen mainScreen] bounds].size.width];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    CGFloat halfWidth = tableView.frame.size.width * 0.5f;
    
    {
        UIImageView* imageview = [[UIImageView alloc] initWithFrame:CGRectMake(10.0f, 10.0f, halfWidth, 180.0f)];
    ...
    
    {
        ...
        button.frame = CGRectMake(halfWidth, 10.0f, halfWidth, 80.0f);
        [button setTitle:@"Clear Filters" forState:UIControlStateNormal];
        [button addTarget:self action:@selector(clearAllFilters) forControlEvents:UIControlEventTouchUpInside];
        [view addSubview:button];
    }
    
    {
        UIButton* button = [UIButton buttonWithType:UIButtonTypeSystem];
        button.frame = CGRectMake(halfWidth, 110, halfWidth, 80.0f);
        [button setTitle:@"Change Image" forState:UIControlStateNormal];
        [button addTarget:self action:@selector(newImageFromGallery) forControlEvents:UIControlEventTouchUpInside];
        [view addSubview:button];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	switch (index)
	{
        ...
        case GPUIMAGE_MATTE: cell.textLabel.text = @"FG Matte"; break;
        case GPUIMAGE_70S: cell.textLabel.text = @"FG 70s"; break;
        case GPUIMAGE_FILM1: cell.textLabel.text = @"FG Film 1"; break;
        case GPUIMAGE_FILM2: cell.textLabel.text = @"FG Film 2"; break;
        case GPUIMAGE_BAWRETRO: cell.textLabel.text = @"FG B&W Retro"; break;
        case GPUIMAGE_BAWREG: cell.textLabel.text = @"FG B&W Reg"; break;
        case GPUIMAGE_WASTED: cell.textLabel.text = @"GTA Wasted"; break;
        case GPUIMAGE_INTERACTIVE_OVERLAY: cell.textLabel.text = @"FG Interactive Overlay"; break;
        case GPUIMAGE_FLARE: cell.textLabel.text = @"FG Flare"; break;
        case GPUIMAGE_GRADIENT: cell.textLabel.text = @"Gradient"; break;
        case GPUIMAGE_GRADIENT_RADIAL: cell.textLabel.text = @"Gradient Radial"; break;
        case GPUIMAGE_NOISE_TEXTURE: cell.textLabel.text = @"FG Kodak Grain"; break;
        case GPUIMAGE_MOODY: cell.textLabel.text = @"FG Moody"; break;
        case GPUIMAGE_FLARE_ICE: cell.textLabel.text = @"FG Flare Ice"; break;
        case GPUIMAGE_WARMTH: cell.textLabel.text = @"FG Warmth"; break;
        case GPUIMAGE_SHARP: cell.textLabel.text = @"FG Sharp"; break;
	}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    filterViewController.image = self.image;
    [self.navigationController pushViewController:filterViewController animated:YES];
}

#pragma mark - ShowcaseFilterDelegate

- (void) addFilterFromShowcaseFilterViewController:(GPUImageFilter*)filter
                                    withNewImage:(UIImage *)newImage
{
...
{
    self.filterArray = [NSMutableArray array];
    self.image = [UIImage imageWithImage:self.originalImage scaledToWidth:[[UIScreen mainScreen] bounds].size.width];
    self.imageView.image = self.image;
}

- (void) newImageFromGallery
{
